...
public class economicCategory extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view=inflater.inflate(R.layout.economic_category,null);
        recyclerViewEconomic=view.findViewById(R.id.recyclervieweconomic);
        modelclassArray=new ArrayList<>();
        recyclerViewEconomic.setLayoutManager(new LinearLayoutManager(getContext()));
